...
namespace CongCuDungCu.Controllers
{
    public partial class DanhSachController: DemoController {
        public override string Name { get { return "DanhSach"; } }
    ...
    public class DanhSachController_Helper
    {
        ...
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMNoiSX" });
        }
        ...
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMDonVi" });
        }
        ...
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMKho" });
        }
        public static string getDMTinhtrang()
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMTinhtrang" });
        }
        public static string getDMNguoidung()
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMNguoidung" });
        ...
        {
            return DevExpressHelper.GetUrl(new { Controller = "DanhSach", Action = "DMDvt" });
        }
